...
A YouTube music player built with Electron and SolidJS.
...
npm run build:linux
```
Output will be in `release/<platform>/`
...
```
ytify/
├── android/               # Android project files (generated)
├── build-configs/        # Desktop platform build configurations
